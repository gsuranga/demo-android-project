...
public class Sugesstion_order_fragment extends Fragment {
	...
	public Sugesstion_order_fragment() {
		update_status = "0";
	...
	public void name(final String uname, final String pw, final String bill_id, final int index, String dealer_name, SuggestionOrder s) {
